        ...
        <div className="glass border border-white/50 shadow-2xl rounded-3xl p-8 dark:border-slate-800/80 transition-all duration-300">
          <div className="flex flex-col items-center mb-6">
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Get started with courses and progress tracking today.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative rounded-2xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full rounded-2xl border border-slate-200 bg-white py-3 pl-11 pr-4 text-sm outline-none transition-all placeholder:text-slate-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:border-slate-800 dark:bg-slate-900 dark:text-white dark:focus:border-brand-500"
